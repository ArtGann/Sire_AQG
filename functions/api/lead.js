...
const normalizePayload = (payload, request) => {
  ...
  return {
    ...
    whole_house_gutters: cleanString(payload.whole_house_gutters),
    gutter_type: cleanString(payload.gutter_type),
    gutter_guards: cleanString(payload.gutter_guards),
    downspout_count: cleanString(payload.downspout_count),
    fascia_option: cleanString(payload.fascia_option),
    soffit_panel_option: cleanString(payload.soffit_panel_option),
    gutter_miter_count: cleanString(payload.gutter_miter_count),
    downspout_connector_count: cleanString(payload.downspout_connector_count),
    fascia_soffit: cleanString(payload.fascia_soffit),
    estimated_linear_feet: cleanString(payload.estimated_linear_feet),
    estimated_price_low: cleanString(payload.estimated_price_low),
    estimated_price_high: cleanString(payload.estimated_price_high),
    estimated_price_range: cleanString(payload.estimated_price_range),
    estimate_details: cleanString(payload.estimate_details),
