...
const services = [
  ...
  },
  {
    ...
    description: "Professional gutter guard installation for PA and NJ homes. Keep leaves, pine needles and roof grit out while rainwater keeps flowing. Free estimates.",
  ...
  },
  {
    ...
    description: "Soffit and fascia repair and installation for PA and NJ homes. Protect the roof edge, preserve ventilation and get a free on-site estimate.",
  ...
  },
  {
    ...
    description: "Downspout installation and replacement for Pennsylvania and New Jersey homes. Move roof runoff away from siding, walkways and foundations. Free estimates.",
...
// This custom visual page is maintained by hand and must not be generated by
// the service-page loop. Keep it in search discovery and the business catalog
// without adding it to `services`, which would overwrite the custom page.
const extraIndexableServices = [
  {
    slug: "gutter-miters-downspout-connectors",
    name: "Gutter Miters & Downspout Connectors",
  },
];
...
const localProfiles = {
  ...
  "furlong-pa": {
    ...
    description: "Gutter installation, guards and soffit work for Furlong, Doylestown and Central Bucks homes. Drainage planned for wooded lots and complex rooflines. Free estimates.",
    region: "Bucks County",
    exposure: "pa",
  ...
  "cape-may-new-jersey": {
    ...
    description: "Gutter services for Cape May and shore-area homes: seamless gutters, guards, fascia repair and downspouts built for salt air and coastal storms. Free estimates.",
  ...
  "hampton-nj": {
    ...
    description: "Gutter services for Hampton, Clinton and Hunterdon County homes: installation, guards, replacement and downspouts for wooded, hilly properties. Free estimates.",
  ...
  "longport-new-jersey": {
    ...
    description: "Gutter services for Longport, Margate and Ventnor homes: seamless gutters, guards and downspouts built for direct coastal exposure on Absecon Island. Free estimates.",
  ...
  "manchester-township-nj": {
    ...
    description: "Gutter guards, installation and fascia work for Manchester Township, Whiting and Ocean County adult communities. Low-maintenance options and free estimates.",
  ...
  "princeton-nj": {
    ...
    description: "Gutter installation, guards and replacement for Princeton area homes with heavy tree canopy. Careful work on established and historic properties. Free estimates.",
  ...
  "vineland-new-jersey": {
    ...
    description: "Seamless gutters, downspouts and replacements for Vineland, Bridgeton and Cumberland County homes. Drainage that handles South Jersey downpours. Free estimates.",
...
function organizationSchema() {
  const offerCatalog = {
    ...
    itemListElement: [...services, ...extraIndexableServices].map((service) => ({
      "@type": "Offer",
      itemOffered: {
        "@type": "Service",
  ...
  return {
    ...
    email: ["info@allqualitygutters.com", "sales@allqualitygutters.com"],
    priceRange: "$$",
    ...
    knowsAbout: ["Seamless gutter installation", "Gutter guards", "Gutter replacement", "Soffit and fascia", "Downspout installation", "Gutter miters", "Downspout connectors", "Gutter installation cost", "Roof runoff drainage"],
...
function head({ title, description, canonical, schema }) {
  return `
    ...
    <meta property="og:image:secure_url" content="${siteUrl}/assets/img/hero-bg-source-match.webp" />
    ...
    <meta name="twitter:image" content="${siteUrl}/assets/img/hero-bg-source-match.webp" />
...
async function loadSharedFooter() {
  ...
  sharedPageExtrasMarkup = extrasMatch[0]
    .replaceAll('src="assets/', 'src="/assets/')
    .replace(/\s*<script src="\/?assets\/js\/review-notes\.js[^"]*"><\/script>/g, "");
}
...
function syncSharedPageExtras(html) {
  const cleaned = html
    ...
    .replace(/\s*<script src="\/?assets\/js\/review-notes\.js[^"]*"><\/script>\s*/g, "");
